...
from MAPF_GNN_master.models.networks.utils_weights import weights_init
from MAPF_GNN_master.models.networks.gnn import GCNLayer
...
class Network(nn.Module):
    ...
    def forward(self, states, gso):
        ...
        return action_logits, features_shared
